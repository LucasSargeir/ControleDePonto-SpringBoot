package com.dio.primeiroProjeto.controller;

import com.dio.primeiroProjeto.model.NivelAcesso;
import com.dio.primeiroProjeto.service.NivelAcessoService;
...
public class NivelAcessoController {
	...
	public ResponseEntity<NivelAcesso> getNivelAcessoByID(@PathVariable("idNivelAcesso") Long idNivelAcesso)throws Exception{
		var nivelAcesso = nivelAcessoService.getById(idNivelAcesso)
				.orElseThrow(()->new IllegalArgumentException("A identificação passada não corresponde a nenhum " +
						"nivel de acesso"));
